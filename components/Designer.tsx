    ...
    <div className="flex w-full h-full">
        ...
        >
            <div 
              ...
              className={`max-w-[920px] h-full m-auto rounded-xl border-2 border-dashed border-zinc-300 dark:border-blue-600
  ...
  return (
    <div 
      ...
      className="relative h-[120px] flex flex-col text-foreground
        hover:cursor-pointer rounded-md ring-1 ring-zinc-600 ring-inset"
      onMouseEnter={() => {
        setMouseIsOver(true);
      }}
      onMouseLeave={() => {
    ...
    >
      ...
      <div 
        className={
        `flex w-full h-[120px] items-center rounded-md 
        bg-zinc-600/40 px-4 py-2 pointer-events-none opacity-100 
